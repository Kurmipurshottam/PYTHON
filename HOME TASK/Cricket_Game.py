...
print('\nTEAMS : CSK MI KKR GT RCB RR LSG DC PBSK SRH ')

team = ['CSK','MI','KKR','GT','RCB','SRH','RR','LSG','DC','PBSK']

user_team_choice = input('\nENTER YOUR TEAM :')

if user_team_choice in team :
    team.remove(user_team_choice)
else:
...
def user():
    ...
    for i in range(80):
        ...
        if counter == 1:
            ...
            run += 1
            balls += 0.1
            print(f"{user_team_choice} : {run} / {wicket}  {balls}")
        ...
        if balls==0.6:
            ...
            print(f'\nTOTAL RUNS {user_team_choice} = {run}')
            break
#_____________________________________________________________________________________________________________
def computer():
    run_list = [1,2,4,6,0,'wicket','no ball','wide']
    ...
    for i in range(80):
        ...
        if counter == 1:
            ...
            run += 1
            balls += 0.1
            print(f"{computer_team_choice} : {run} / {wicket}  {balls}")
    ...
    if user_choice == 'bat':
        try:
            ...
            if user_list == computer_list:
                ...
                print(f"\n<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<{user_team_choice} won the match>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
